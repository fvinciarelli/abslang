...
v0.1 — the conceptual core is closed (Session, Behavior, Actor, Action, Target, Content, Variables, Evaluations, Fragments, Tool Interaction, JSON Schema). Implementations in TypeScript and Python, plus a React UI editor, a Next.js docs site, and a VSCode extension. See [Roadmap](/docs/roadmap) for open design questions deferred to v0.2+.
