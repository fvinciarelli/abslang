...
OpenAI, Anthropic, or Gemini from your environment. Azure AI Foundry and AWS Bedrock
ship as ready-to-use engines; safety dimensions (`HateUnfairness`, `Violence`,
`Sexual`, `SelfHarm`) run on the built-in judge with a curated rubric — no criteria.
