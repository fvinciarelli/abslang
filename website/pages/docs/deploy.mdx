...
.github/workflows/deploy-website.yml
    ...
    └─ Deploy to GitHub Pages
        │
        ▼
https://fvinciarelli.github.io/abslang
```
...
```js
const nextConfig = {
  basePath: '/abslang',           // Serves from /abslang (project page), not /
...
1. Go to [Actions](https://github.com/fvinciarelli/abslang/actions)
