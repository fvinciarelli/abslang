...
This document is the normative entry point for the Agent Behavior Specification. It defines document format, required and optional fields, and conformance rules. Conceptual definitions and rationale live in the [Core Model](/docs/core-model); this document is the formal reference for implementers.
...
See the [Manifesto](/docs/manifesto), "What ABS is not."
