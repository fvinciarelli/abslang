...
export const frontmatter = { title: 'Specification v0.2', description: 'Normative reference for document format, fields, and conformance.' };
...
This is **not valid YAML** — a block mapping cannot be directly followed by a block sequence at the same indentation level. All documents in this project use the explicit `behaviors:` form, which is the only form v0.2 defines as conformant.
