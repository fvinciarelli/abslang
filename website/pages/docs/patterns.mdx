...
Each branch is its own Session. Same structure, different `sequence` and `never` guards. See the [full example on GitHub](https://github.com/fvinciarelli/abs/blob/main/examples/intent-routing.yaml).
